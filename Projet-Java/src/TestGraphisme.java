	...
	public static void main( String [ ] args ) throws InterruptedException {
		...
		for ( int i =0;i <10; i++) {
			...
			while(jake.getResteAJouer() > 0) {
				...
				//Thread.sleep(1000) ; 
				//System.out.println(jake.getResteAJouer()+" coups a  jouer");
				;
			}
			...
			while(mark.getResteAJouer() > 0) {
				...
				//System.out.println(mark.getResteAJouer()+" coups a  jouer");
			}
			System.out.println("Position réelle Y de mark: " +mark.getY());
